...
checkpoint = {'model_match_even':checkpoint_even,'model_match_odd':checkpoint_odd, 'model_invert_even':checkpoint_even_inv,'model_invert_odd':checkpoint_odd_inv}

torch.save(checkpoint,'Model_1.pth')
